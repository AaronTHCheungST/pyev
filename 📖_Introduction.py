...
st.write("""
         This tool is developed for Python developers who want to check the dependencies within a development environment (e.g., conda, venv) to check if the licenses of the installed packages are compatible to the intended license of their developed program.
